...
class RandomWordGen():
    ...
    def GetNoun(self):
        randomWord = self.RandomLine("Assets/WordBank/nouns.txt")
        return randomWord

    def GetVerb(self):
        randomWord = self.RandomLine("Assets/WordBank/verbs.txt")
        return randomWord

    def GetAdj(self):
        randomWord = self.RandomLine("Assets/WordBank/adjectives.txt")
        return randomWord
